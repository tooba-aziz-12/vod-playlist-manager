package com.example.api.spring_boot_kotlin_service.security.config
...
internal class ApplicationSecurityConfigurationTest {
    private lateinit var securityConfig: com.example.api.spring_boot_kotlin_service.security.config.ApplicationSecurityConfiguration

    @Mock
    private val preAuthorizationFilter: PreAuthorizationFilter = PreAuthorizationFilter()
    @BeforeEach
    fun beforeEach() {
        securityConfig = com.example.api.spring_boot_kotlin_service.security.config.ApplicationSecurityConfiguration(
